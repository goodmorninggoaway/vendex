exports.up = function (knex) {
  return knex.schema.createTable('language', function (table) {
    ...
    .then(() => knex.table('language').insert([
      ...
      { language: 'Chinese Cantonese', synonyms: ['Chinese Cantonese', 'Cantonese', 'Cantonese Chinese'] },
      { language: 'Chinese Mandarin', synonyms: ['Chinese Mandarin', 'Mandarin', 'Mandarin Chinese`'] },
