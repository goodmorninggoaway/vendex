...
module.exports = async ({ congregationId, outputDirectory }) => {
...
console.log(activities.length, locations.length, congregationId);
        locations = keyBy(locations, 'location.locationId');
console.log(activities.length, locations.length);
