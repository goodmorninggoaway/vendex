...
module.exports.findTerritory = (filter) => selectFirstOrDefault({ filter: { ...filter, deleted: 0 }, table: 'territory' });
module.exports.getTerritories = (filter) => select({ filter: { ...filter, deleted: 0 }, table: 'territory' });
